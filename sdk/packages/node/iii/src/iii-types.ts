...
export type RegisterFunctionMessage = {
  ...
  description?: string
  /**
   * JSON Schema or custom format describing expected input.
   * The engine auto-generates standard JSON Schema from Rust types.
   */
  request_format?: RegisterFunctionFormat | Record<string, unknown>
  /**
   * JSON Schema or custom format describing expected output.
   * The engine auto-generates standard JSON Schema from Rust types.
   */
  response_format?: RegisterFunctionFormat | Record<string, unknown>
 ...
 *
 * The engine auto-generates standard JSON Schema for `request_format` and
 * `response_format` from Rust types via `schemars`. When listing functions,
 * these fields contain JSON Schema objects.
 */
export type FunctionInfo = {
  ...
  description?: string
  /** JSON Schema describing expected request format. Auto-generated by the engine. */
  request_format?: Record<string, unknown>
  /** JSON Schema describing expected response format. Auto-generated by the engine. */
