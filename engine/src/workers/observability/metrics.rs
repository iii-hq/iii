...
//!
//! This worker provides metrics collection via OpenTelemetry with support for
...
/// If OtelWorker later calls `init_metrics()`, it will find the meter already set
...
mod tests {
    ...
    //    These tests use ingest_otlp_metrics from the otel worker and require
