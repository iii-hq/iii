...
mod tests {
    ...
    #[tokio::test]
    async fn test_disabled_telemetry_worker_name() {
        let worker = DisabledTelemetryWorker;
        assert_eq!(worker.name(), "Telemetry");
    }

    #[tokio::test]
    async fn test_disabled_telemetry_worker_initialize() {
        let worker = DisabledTelemetryWorker;
    ...
    #[tokio::test]
    async fn test_disabled_telemetry_worker_start_background_tasks() {
        let worker = DisabledTelemetryWorker;
        let (tx, rx) = tokio::sync::watch::channel(false);
        let result = worker.start_background_tasks(rx, tx).await;
        assert!(result.is_ok());
    }

    #[tokio::test]
    async fn test_disabled_telemetry_worker_destroy() {
        let worker = DisabledTelemetryWorker;
        let result = worker.destroy().await;
        assert!(result.is_ok());
    }

    #[tokio::test]
    async fn test_disabled_telemetry_worker_create() {
        let engine = make_test_engine();
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_disabled_by_config() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
        ...
        let worker = TelemetryWorker::create(engine, Some(config)).await.unwrap();
        assert_eq!(worker.name(), "Telemetry");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_disabled_by_env_optout() {
        clear_ci_env_vars();
        unsafe {
            env::set_var("III_TELEMETRY_ENABLED", "false");
            env::remove_var("III_TELEMETRY_DEV");
        ...
        let engine = make_test_engine();
        let worker = TelemetryWorker::create(engine, None).await.unwrap();
        assert_eq!(worker.name(), "Telemetry");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_disabled_by_ci() {
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
        }
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_disabled_by_dev_optout() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::set_var("III_TELEMETRY_DEV", "true");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_enabled_by_default() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_with_sdk_api_key() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_create_with_empty_sdk_api_key() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
    ...
    fn test_active_client_prefers_sdk_client_when_available() {
        let engine = make_test_engine();
        let without_sdk = build_manual_worker(engine.clone(), false, 1);
        assert!(Arc::ptr_eq(
            without_sdk.active_client(),
            &without_sdk.client
        ));

        let with_sdk = build_manual_worker(engine, true, 1);
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_name_is_telemetry() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_initialize_is_ok() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
    ...
    #[tokio::test]
    #[serial]
    async fn test_telemetry_worker_background_tasks_and_destroy_run_without_network() {
        clear_ci_env_vars();
        unsafe {
            env::remove_var("III_TELEMETRY_ENABLED");
            env::remove_var("III_TELEMETRY_DEV");
        ...
        let worker = build_manual_worker(engine, true, 1);
        ...
        worker.destroy().await.expect("destroy telemetry worker");
