...
mod tests {
    ...
    async fn test_set_and_get() {
        ...
        let result = worker.set(set_input).await;
        ...
        let result = worker.get(get_input).await;
        match result {
    ...
    async fn test_delete_existing_key() {
        ...
        let result = worker.delete(delete_input).await;
        match result {
            FunctionResult::Success(Some(value)) => {
    ...
    async fn test_list_scope() {
        ...
        let result = worker.list(list_input).await;
        match result {
            FunctionResult::Success(Some(value)) => {
    ...
    async fn test_list_groups() {
        ...
        let result = worker.list_groups(StateListGroupsInput {}).await;
        match result {
            FunctionResult::Success(value) => {
    ...
    async fn test_invoke_triggers_scope_filter() {
...

        {
            ...
            .unwrap();
            worker.triggers.list.write().await.insert(
                trigger.id.clone(),
        ...
        worker.invoke_triggers(event_data).await;
    ...
    async fn test_update_operation() {
        ...
        let result = worker.update(update_input).await;
        assert!(matches!(result, FunctionResult::Success(_)));
    ...
    async fn test_initialize_registers_trigger_type_and_destroy_calls_adapter() {
        ...
        let (engine, worker) = setup_with_adapter(adapter.clone());
    ...
    async fn test_set_returns_failure_when_adapter_errors() {
        ...
        let (_engine, worker) = setup_with_adapter(adapter);
