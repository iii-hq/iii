...
use crate::{
    ...
    workers::http::types::{HttpRequest, HttpResponse},
...
mod tests {
    ...
    use crate::workers::http::api_core::{HttpWorker, PathRouter};
    use crate::workers::http::types::HttpRequest;
    ...
    fn make_test_api_handler(engine: Arc<Engine>) -> Arc<HttpWorker> {
        use crate::workers::http::config::RestApiConfig;
