...
Plans:
- [ ] 06-01-PLAN.md — E2E tests for private IP blocking (HTTP-06), HTTPS enforcement (HTTP-07), and DNS failure handling (HTTP-08) via strict_invoker
...
Plans:
- [ ] 07-01-PLAN.md — E2E tests for RabbitMQ payload integrity (QRMQ-01) and topology verification via AMQP passive declares + Management API (QRMQ-07)
