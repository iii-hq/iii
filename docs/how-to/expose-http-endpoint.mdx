...
Use this when you need to expose iii functions to HTTP clients (web apps, mobile apps, external services). Requires the `iii-http` worker. For WebSocket-based clients, see [Use the Browser SDK](/how-to/use-iii-in-the-browser).
