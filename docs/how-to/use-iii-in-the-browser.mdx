...
<Callout type="info">
For listing functions, workers, triggers, trigger types, or subscribing to topology changes from the browser, see [Discover workers, functions, and triggers](/how-to/discover-workers-functions-triggers).
</Callout>
