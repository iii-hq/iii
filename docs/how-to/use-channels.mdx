...
<Info title="Architecture deep-dive">
  For internal details on the WebSocket framing, backpressure handling, and lazy connection behavior, see the [Channels architecture](/docs/architecture/channels) reference.
</Info>
...
<CardGroup cols={2}>
  <Card title="Channels Architecture" href="/docs/architecture/channels" icon="sitemap">
    Internal design: WebSocket framing, backpressure, and lazy connections
  </Card>
  <Card title="Expose an HTTP Endpoint" href="/docs/how-to/expose-http-endpoint" icon="globe">
    Register a function as a REST API endpoint
  </Card>
  <Card title="Use Functions & Triggers" href="/docs/how-to/use-functions-and-triggers" icon="bolt">
    Learn how to register and trigger functions across languages
  </Card>
  <Card title="Stream Real-Time Data" href="/docs/how-to/stream-realtime-data" icon="signal-stream">
