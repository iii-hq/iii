...
Before creating a custom type, check the [built-in trigger types](/docs/how-to/use-functions-and-triggers#trigger-types) — `http`, `cron`, `durable:subscriber`, `subscribe`, `state`, and `stream` cover the most common event sources.
</Info>
