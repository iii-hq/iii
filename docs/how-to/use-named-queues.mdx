...
<Info title="Full configuration reference">
  For complete configuration options please refer to [Queue worker reference](/docs/workers/iii-queue#configuration).
</Info>
...
<Info title="Full configuration reference">
  ...
  For full configuration options refer to the [Queue worker reference](/docs/workers/iii-queue#queue-configuration).
</Info>
...
<Info title="Standard vs FIFO queues">
  For a detailed comparison of standard and FIFO queue behavior — including processing model, ordering guarantees, and flow diagrams — see the [Queue worker reference](/docs/workers/iii-queue#standard-vs-fifo-queues). For retry and dead-letter flow, see [Retry and dead-letter flow](/docs/workers/iii-queue#retry-and-dead-letter-flow).
</Info>
...
<Info title="Adapters and configuration">
  For adapter options (builtin, RabbitMQ, Redis), scenario-based recommendations, and the full queue configuration reference, see the [Queue worker reference](/docs/workers/iii-queue#adapter-comparison).
</Info>
...
<CardGroup cols={2}>
  <Card title="Topic-Based Queues" href="/docs/how-to/use-topic-queues" icon="tower-broadcast">
    Fan out messages to multiple subscribers with durable pub-sub
  </Card>
  <Card title="Trigger Actions" href="/docs/how-to/trigger-actions" icon="bolt">
    Understand synchronous, Void, and Enqueue invocation modes
  </Card>
  <Card title="Dead Letter Queues" href="/docs/how-to/dead-letter-queues" icon="skull">
    Handle and redrive failed queue messages
  </Card>
  <Card title="Queue Worker Reference" href="/docs/workers/iii-queue" icon="gear">
