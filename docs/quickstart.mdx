...
<CardGroup cols={2}>
  <Card title="How to use Functions & Triggers" href="/docs/how-to/use-functions-and-triggers" icon="book-open">
    Learn how to register functions, trigger them, and bind them to events.
  </Card>
  <Card title="Concepts" href="/docs/primitives-and-concepts/functions-triggers-workers" icon="table-layout">
