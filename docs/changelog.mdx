...
<Update label="0.11.0" description="April 2026">
  ...
  **Breaking.** The convenience discovery wrappers were removed from the Node, browser, Rust, and Python SDKs:
  ...
  [Read the Worker RBAC guide &rarr;](/docs/how-to/worker-rbac)
  ...
  [Define request/response formats &rarr;](/docs/how-to/define-request-response-formats) &middot; [Trigger architecture &rarr;](/docs/architecture/trigger-types)
  ...
  [Use iii in the browser &rarr;](/docs/how-to/use-iii-in-the-browser)
  ...
  [Managing Container Workers &rarr;](/docs/how-to/managing-container-workers) &middot; [Developing Sandbox Workers &rarr;](/docs/how-to/developing-sandbox-workers)
  ...
  [Exec into a running worker &rarr;](/docs/how-to/managing-container-workers#5-exec-into-a-running-worker)
  ...
  [Reproduce Worker Installs &rarr;](/docs/how-to/reproduce-worker-installs)
  ...
  **Breaking.** The topic-based queue API has been renamed. The trigger type changes from `queue` to `durable:subscriber`, and the publish function changes from `enqueue` to `iii::durable::publish`:
  ...
  [Use topic-based queues &rarr;](/docs/how-to/use-topic-queues)
