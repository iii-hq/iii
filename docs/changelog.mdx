...
<Update label="0.11.0" description="April 2026">
  ...
  **Breaking.** The convenience discovery wrappers were removed from the Node, browser, Rust, and Python SDKs:
  ...
  [Use the Browser SDK &rarr;](/how-to/use-iii-in-the-browser)
  ...
  [Manage Container Workers &rarr;](/how-to/manage-container-workers) &middot; [Develop Sandbox Workers &rarr;](/how-to/develop-sandbox-workers)
  ...
  [Exec into a running worker &rarr;](/how-to/manage-container-workers#exec-into-a-running-worker)
