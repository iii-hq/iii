...
{/* TODO: re-enable the "## 3. Install the VS Code Extension (Optional)" section below once the iii-lsp extension is more thoroughly tested across VS Code, Cursor, Windsurf, and VSCodium. The Frame demo also needs `/images/lsp.mp4` to be captured and committed before the section is re-added.
