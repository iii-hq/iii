...
iii.register_function(RegisterFunctionMessage { id: "cron.periodic_job".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, |_input| async move {
    let logger = Logger();
...
iii.register_function(RegisterFunctionMessage { id: "job.handle_tick".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, |input| async move {
    let logger = Logger();
...
iii.register_function(RegisterFunctionMessage { id: "cron.orders_sweep".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, |_input| async move {
    let logger = Logger();
