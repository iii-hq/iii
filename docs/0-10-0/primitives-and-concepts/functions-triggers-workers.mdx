...
Head over to the [Functions & Triggers](/0-10-0/how-to/use-functions-and-triggers) HOWTO and start building
a iii powered application; or visit the [Quickstart](/0-10-0/quickstart) and try out a working example.

## Still want to learn more?

Check out how [Discovery](/0-10-0/primitives-and-concepts/discovery) works within iii and how it compares to other solutions.

<CardGroup cols={2}>
  <Card title="How to use Functions & Triggers" href="/0-10-0/how-to/use-functions-and-triggers" icon="book-open">
    Learn how to register functions, trigger them, and bind them to events.
  </Card>
  <Card title="Quickstart" href="/0-10-0/quickstart" icon="terminal">
