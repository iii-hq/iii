...
Before creating a custom type, check the [built-in trigger types](/0-10-0/how-to/use-functions-and-triggers#trigger-types) — `http`, `cron`, `queue`, `subscribe`, `state`, and `stream` cover the most common event sources.
</Info>
