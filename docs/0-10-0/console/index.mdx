...
<Info title="Trigger types">
  The available trigger types depend on which modules are loaded in your engine configuration. See [Trigger Types](../architecture/trigger-types) and [Modules](../modules/index) for the full list.
</Info>
