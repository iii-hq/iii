...
| `registerfunction` | `function_id`, `metadata` | Register a function. On RBAC ports, requires `allow_function_registration` and passes the optional `on_function_registration_function_id` hook. |
