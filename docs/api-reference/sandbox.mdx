...
iii trigger sandbox::exec --json "{\"sandbox_id\":\"$SB\",\"cmd\":\"python3\",\"args\":[\"-c\",\"print(2+2)\"]}"
...
| `iii sandbox exec "$SB" -- python3 -c 'print(2+2)'` | `iii trigger sandbox::exec --json '{"sandbox_id":"…","cmd":"python3","args":["-c","print(2+2)"]}'` |
