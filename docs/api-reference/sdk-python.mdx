...
| `request_format` | [`RegisterFunctionFormat`](#registerfunctionformat) \| None | No | Schema describing expected input. |
| `response_format` | [`RegisterFunctionFormat`](#registerfunctionformat) \| None | No | Schema describing expected output. |
