...
| `request_format` | [`RegisterFunctionFormat`](#registerfunctionformat) \| Record&lt;string, unknown&gt; | No | JSON Schema or custom format describing expected input.<br />The engine auto-generates standard JSON Schema from Rust types. |
| `response_format` | [`RegisterFunctionFormat`](#registerfunctionformat) \| Record&lt;string, unknown&gt; | No | JSON Schema or custom format describing expected output.<br />The engine auto-generates standard JSON Schema from Rust types. |
...
| `metadata` | `Record<string, unknown>` | No | Arbitrary metadata attached to the function. |
| `request_format` | `Record<string, unknown>` | No | JSON Schema describing expected request format. Auto-generated by the engine. |
| `response_format` | `Record<string, unknown>` | No | JSON Schema describing expected response format. Auto-generated by the engine. |
