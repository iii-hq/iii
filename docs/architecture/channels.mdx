...
iii.register_function(RegisterFunctionMessage { id: "data.processor".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "data.sender".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "stream.worker".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "stream.coordinator".into(), description: None, request_format: None, response_format: None, metadata: None, invocation: None }, move |input: Value| {
