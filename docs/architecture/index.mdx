...
<CardGroup cols={2}>
  <Card title="Engine" href="/docs/architecture/engine" icon="server">
    Engine runtime, routing, and configuration.
  </Card>
  <Card title="Workers" href="/docs/architecture/workers" icon="boxes">
    Built-in and external worker model.
  </Card>
  <Card title="Trigger Types" href="/docs/architecture/trigger-types" icon="bolt">
    Trigger registration and call semantics.
  </Card>
  <Card title="Queues" href="/docs/architecture/queues" icon="list-ordered">
