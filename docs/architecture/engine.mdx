...
See [Discover workers, functions, and triggers](/how-to/discover-workers-functions-triggers) for the full catalogue of discovery functions and trigger types.
