...
sidebarTitle: "Python"
description: "API reference for the iii-helpers package for Python workers: utilities for triggers, channels, state, sandboxes, and observability integration."
owner: "engineering"
type: "reference"
---
