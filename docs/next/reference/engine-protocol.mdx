...
description: "Reference for the raw WebSocket protocol iii SDK workers and the engine speak: framing, message types, handshake, error codes, and channel semantics."
owner: "engineering"
type: "reference"
---
