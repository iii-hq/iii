---
title: "iii engine WebSocket protocol reference"
description: "Wire-level reference for the WebSocket protocol iii workers and the engine exchange, covering message framing, function calls, triggers, and channels."
owner: "engineering"
type: "reference"
---
