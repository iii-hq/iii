---
title: "iii Browser SDK API reference"
description: "API reference for the iii Browser SDK for TypeScript: connect a browser tab to the engine, call functions, and subscribe to triggers over WebSocket."
owner: "engineering"
type: "reference"
---
