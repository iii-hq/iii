---
title: "Browser SDK"
description: "API reference for the iii SDK for browsers and TypeScript: connect a browser tab to the engine, register functions, and subscribe to live triggers."
owner: "engineering"
type: "reference"
---
