---
title: "iii Rust SDK API reference"
description: "API reference for the iii Rust SDK: connect a Rust worker to the engine, register functions and triggers, and call functions from other workers."
owner: "engineering"
type: "reference"
---
