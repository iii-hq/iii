...
| `new` | `fn(expression: impl Into<String>) -> Self` | Yes | - |
...
| `condition_function_id` | `Option<String>` | No | Optional function ID to evaluate before invoking handler |
| `condition` | `fn(function_id: impl Into<String>) -> Self` | Yes | - |
| `method` | fn(method: [`HttpMethod`](#httpmethod)) -&gt; Self | Yes | - |
| `new` | `fn(api_path: impl Into<String>) -> Self` | Yes | - |
...
| `level` | fn(level: [`LogLevel`](#loglevel)) -&gt; Self | Yes | - |
| `new` | `fn() -> Self` | Yes | - |
...
| `condition` | `fn(function_id: impl Into<String>) -> Self` | Yes | - |
| `new` | `fn(topic: impl Into<String>) -> Self` | Yes | - |
...
| `condition_function_id` | `Option<String>` | No | Optional function ID to evaluate before invoking handler |
| `condition` | `fn(function_id: impl Into<String>) -> Self` | Yes | - |
| `key` | `fn(key: impl Into<String>) -> Self` | Yes | - |
| `new` | `fn() -> Self` | Yes | - |
| `scope` | `fn(scope: impl Into<String>) -> Self` | Yes | - |
