---
title: "Node.js SDK"
description: "API reference for the iii SDK for Node.js and TypeScript: connect a worker to the engine, register functions, define triggers, and stream channels."
owner: "engineering"
type: "reference"
---
