---
title: "iii Node.js SDK API reference"
description: "API reference for the iii Node.js and TypeScript SDK: connect a worker to the engine, register functions and triggers, and call functions from Node."
owner: "engineering"
type: "reference"
---
