---
title: "Upgrade iii workers from 0.21.x to 0.22.x"
description: "Rename the always-running workers, drop the removed engine flag, and update the Rust register-function API when moving your iii project to 0.22.x."
owner: "devrel"
type: "how-to"
---
