...
description: "Move a Node, Python, or Rust worker from iii-sdk 0.19.x to the reorganized 0.20.x surface: renamed helpers, new imports, and updated trigger APIs."
owner: "devrel"
type: "how-to"
---
