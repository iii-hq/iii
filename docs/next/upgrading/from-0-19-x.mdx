---
title: "Upgrade iii workers from 0.19.x to 0.20.x"
description: "Migrate Node, Python, and Rust workers from iii-sdk 0.19.x to the reorganized 0.20.x surface, including the new @iii-dev/helpers package and submodules."
owner: "devrel"
type: "how-to"
---
