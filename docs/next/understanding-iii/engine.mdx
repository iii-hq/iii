---
title: "How the iii engine works"
description: "How the iii engine starts up, loads workers from config.yaml, and routes function calls, triggers, and channels between workers as a fixed coordinator."
owner: "devrel"
type: "explanation"
---
