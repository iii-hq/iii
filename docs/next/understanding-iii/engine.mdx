---
title: "Engine"
description: "How the iii engine acts as a thin router that connects workers, dispatches triggers to functions, and moves data between them over a WebSocket protocol."
owner: "devrel"
type: "explanation"
---
