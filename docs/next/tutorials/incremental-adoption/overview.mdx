---
title: "Incremental adoption of iii: tutorial overview"
description: "Adopt iii inside an existing system one slice at a time: wrap the current API, offload work to a queue, then migrate persistence to state workers."
owner: "devrel"
type: "tutorial"
---
