...
description: "Push Linkly link clicks to subscribers in real time with a dedicated click-streamer worker built on iii-stream, without polling or pub/sub glue."
owner: "devrel"
type: "tutorial"
---
