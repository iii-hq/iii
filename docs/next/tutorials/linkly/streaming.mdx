...
description:
  "Push clicks to subscribers in real time with a dedicated click-streamer worker and stream."
owner: "devrel"
type: "tutorial"
---

`stream` is for **real-time data transmission**: pushing data to a client the moment it changes,
