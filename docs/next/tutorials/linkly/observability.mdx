...
description: "Watch the Linkly URL shortener run live in the iii console, then read the same logs and traces directly from the engine for local debugging."
owner: "devrel"
type: "tutorial"
---
