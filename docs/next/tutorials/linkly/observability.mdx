---
title: "Linkly ch. 2: Observe Linkly in the iii console"
description: "Watch Linkly's functions, triggers, and channels run live in the iii console, then read the same traces, logs, and metrics from the engine directly."
owner: "devrel"
type: "tutorial"
---
