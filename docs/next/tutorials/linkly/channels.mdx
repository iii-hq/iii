...
description: "Send a large amounts of data over channels by bulk-loading links from a CSV."
owner: "devrel"
type: "tutorial"
---
...
streams the CSV in, and triggers `link::create` to create a link per row:
