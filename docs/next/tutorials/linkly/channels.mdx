---
title: "Linkly ch. 6: Move bulk data with iii channels"
description: "Stream a large CSV of links into Linkly through an importer worker that pushes rows over an iii channel instead of a single oversized function payload."
owner: "devrel"
type: "tutorial"
---
