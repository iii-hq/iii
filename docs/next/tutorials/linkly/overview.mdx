---
title: "Linkly tutorial: build a URL shortener on iii"
description: "Tutorial that grows Linkly from a single link worker into a multi-tenant URL shortener on iii, adding queues, channels, streaming, and a browser client."
owner: "devrel"
type: "tutorial"
---
