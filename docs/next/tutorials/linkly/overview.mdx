...
Broadcast every click in real time from a dedicated `click-streamer` worker with `iii-stream`, and
bulk-load links from a CSV over a channel.

## Ch. 6: Schedule maintenance
