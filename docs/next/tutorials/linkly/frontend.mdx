---
title: "Linkly ch. 7: Bring the browser into iii"
description: "Turn a browser tab into a Linkly worker that creates links, shows live click streams, and answers server-initiated prompts over the iii engine."
owner: "devrel"
type: "tutorial"
---
