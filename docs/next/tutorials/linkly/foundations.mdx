---
title: "Linkly ch. 1: Foundations of the link worker"
description: "Build Linkly's first iii worker with link::create and link::resolve functions, then expose them over HTTP so users can shorten and follow links."
owner: "devrel"
type: "tutorial"
---
