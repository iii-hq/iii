---
title: "Ch. 8: Create sandboxed link safety agents"
description:
  "Drop in an autonomous LLM agent that samples new links, investigates destinations in sandboxes,
  and quarantines or asks a human to confirm deletion."
owner: "devrel"
type: "tutorial"
---
...
LM Studio, plus turn orchestration, credentials, budgets, and approval-gate. Because it is a worker,
you get all of the immediate benefits of iii: process isolation, interoperability, and dynamic
registration of new functionality.
