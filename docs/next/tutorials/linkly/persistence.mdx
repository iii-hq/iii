...
description: "Add a SQLite database to the Linkly URL shortener for durable link storage and a timestamped row for every click, wired through an iii state worker."
owner: "devrel"
type: "tutorial"
---
