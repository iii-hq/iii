---
title: "Linkly ch. 3: Persist links and clicks in SQLite"
description: "Add a SQLite database to Linkly so links survive restarts and every click is recorded as a timestamped row you can query for analytics later on."
owner: "devrel"
type: "tutorial"
---
