...
description: "Move click-row writes for the Linkly URL shortener onto an iii queue and broadcast link events so independent subscriber workers stay in sync."
owner: "devrel"
type: "tutorial"
---
