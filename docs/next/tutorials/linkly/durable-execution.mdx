---
title: "Linkly ch. 4: Durable execution with queues"
description: "Move click-row writes off the request path onto an iii queue, then broadcast link events so independent subscribers can react without blocking clicks."
owner: "devrel"
type: "tutorial"
---
