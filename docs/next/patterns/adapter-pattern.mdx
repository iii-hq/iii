...
description: "Wrap an existing service, API, or database as an iii worker so it joins the system like any other worker, addressable by function_id from anywhere."
owner: "devrel"
type: "how-to"
---
