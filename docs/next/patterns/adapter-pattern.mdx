---
title: "Adapter pattern: wrap an existing service as an iii worker"
description: "Wrap a third-party API, library, or in-house microservice as a thin iii worker that exposes its capabilities as functions the engine can route to."
owner: "devrel"
type: "how-to"
---
