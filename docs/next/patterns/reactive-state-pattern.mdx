...
description: "Drive iii function execution from state changes instead of explicit invocation: watch state keys, react to writes, and compose reactive pipelines."
owner: "devrel"
type: "how-to"
---
