---
title: "Reactive state pattern in iii"
description: "Bind iii functions to state-change triggers so the engine fires them whenever a watched key or scope changes, no explicit invocation required."
owner: "devrel"
type: "how-to"
---
