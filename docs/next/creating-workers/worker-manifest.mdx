...
description: "Complete field reference for iii.worker.yaml: worker metadata, dependencies, platform targets, function and trigger declarations, and config schema."
owner: "devrel"
type: "reference"
---
