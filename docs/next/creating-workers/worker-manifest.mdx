---
title: "iii.worker.yaml manifest field reference"
description: "Every field in the iii.worker.yaml manifest: runtime, dependencies, process command, and configuration the engine reads when starting your worker."
owner: "devrel"
type: "reference"
---
