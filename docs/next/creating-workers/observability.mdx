---
title: "Observability"
description: "Traces, metrics, and logs for a iii system through the observability worker."
owner: "devrel"
type: "how-to"
---
...
without each worker instrumenting itself. The `observability` worker turns that information into
...
<Note>
  ...
  see the [observability worker docs](https://workers.iii.dev/workers/observability).
</Note>
