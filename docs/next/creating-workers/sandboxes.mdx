---
title: "Sandboxes"
description: "Run untrusted or short-lived code in an isolated microVM from an iii worker by binding functions to the sandbox trigger type and its lifecycle."
owner: "devrel"
type: "how-to"
---
