---
title: "Run untrusted code with the iii-sandbox worker"
description: "Execute short-lived or untrusted code in an isolated microVM through iii-sandbox, useful for agent tool calls, REPLs, and one-off jobs."
owner: "devrel"
type: "how-to"
---
