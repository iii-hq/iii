---
title: "Expose iii functions over HTTP"
description: "Turn any iii function into a REST endpoint with the http worker: routes, methods, request payloads, and responses without a separate web server."
owner: "devrel"
type: "how-to"
---
