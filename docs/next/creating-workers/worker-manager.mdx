...
description: "Accept untrusted iii worker connections behind RBAC-gated listeners served by the iii-worker-manager worker, with tokens, roles, and audit hooks."
owner: "devrel"
type: "how-to"
---
