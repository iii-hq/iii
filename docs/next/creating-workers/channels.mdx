---
title: "Stream large payloads with channels"
description: "Move large or binary payloads (files, media, datasets) between iii workers over dedicated streaming channels instead of JSON function payloads."
owner: "devrel"
type: "how-to"
---
