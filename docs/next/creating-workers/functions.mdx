---
title: "Functions"
description: "Author, register, and export the functions a new iii worker contributes so other workers can invoke them by name, with typed inputs and outputs."
owner: "devrel"
type: "how-to"
---
