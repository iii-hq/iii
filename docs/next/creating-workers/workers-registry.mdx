---
title: "Publish workers to the iii registry"
description: "Package a worker's binary or OCI image, tag a semver version, and publish it to workers.iii.dev so other iii projects can install it by name."
owner: "devrel"
type: "how-to"
---
