---
title: "Registry"
description: "Publish an iii worker to the iii registry so other projects can install it by name, plus semver versioning and cross-platform binary artifacts."
owner: "devrel"
type: "how-to"
---
