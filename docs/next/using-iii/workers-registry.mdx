---
title: "Browse and install workers from the iii registry"
description: "Find installable iii workers on workers.iii.dev, review each worker's functions, triggers, config schema, and platforms, then add them with iii worker add."
owner: "devrel"
type: "how-to"
---
