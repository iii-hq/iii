---
title: "Register and invoke iii functions in your project"
description: "Register functions on a worker with worker.registerFunction, then invoke them by function_id from other workers, the CLI, or event-bound triggers."
owner: "devrel"
type: "how-to"
---
