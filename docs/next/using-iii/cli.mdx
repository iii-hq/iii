---
title: "Use the iii CLI to run and manage your system"
description: "Use the iii CLI to discover subcommands, trigger functions, start the engine, and manage workers and config from the terminal in local and deployed systems."
owner: "devrel"
type: "how-to"
---
