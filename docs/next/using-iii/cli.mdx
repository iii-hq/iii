...
<Note>
  The full CLI surface is also published as an automatically generated reference:
  [iii](../cli-reference/iii), [iii worker](../cli-reference/iii-worker), and [iii
  console](../cli-reference/iii-console).
</Note>
