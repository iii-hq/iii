---
title: "Engine"
description: "Configure and run the iii engine from config.yaml: worker lists, first-boot config seeds, engine flags, and default configuration for new projects."
owner: "devrel"
type: "how-to"
---
