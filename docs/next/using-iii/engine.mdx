---
title: "Run and configure the iii engine"
description: "Configure and run the iii engine as the router between workers, including config.yaml structure, engine flags, and how the engine loads workers on startup."
owner: "devrel"
type: "how-to"
---
