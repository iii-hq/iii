---
title: "Configure iii workers with the configuration worker"
description: "How iii splits config across config.yaml and the configuration worker so each worker has a live file updated from disk, the console, or configuration::set."
owner: "devrel"
type: "how-to"
---
