...
description: "Fixes for common errors when running the iii engine and workers: connection failures, port conflicts, missing config, and worker registration problems."
owner: "devrel"
type: "how-to"
---
