...
see [Understanding iii](./understanding-iii/index). It uses this project as the worked example.
...
<CardGroup cols={2}>
  ...
  <Card title="Understanding iii" href="./understanding-iii/index" icon="table-layout">
