...
<Callout type="info">Middleware functions must be registered separately with `registerFunction`. See [Use HTTP middleware](/docs/how-to/use-http-middleware) for details.</Callout>
</Tab>
</Tabs>
