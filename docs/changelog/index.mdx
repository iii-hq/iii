...
<Update label="0.14.0" description="May 2026">
  ...
  **Breaking.** Eight items moved off the `III` / `ISdk` instance into a dedicated `helpers` submodule across the Rust, Node, Python, and Browser SDKs. The free functions take the iii client as their first argument. Imports now go through a subpath.
  ...
  |---|---|---|---|---|
  | `register_trigger_type` | `iii_sdk::helpers::register_trigger_type` | `iii-sdk/helpers` | `iii-browser-sdk/helpers` | `iii.helpers` |
  | `unregister_trigger_type` | `iii_sdk::helpers::unregister_trigger_type` | `iii-sdk/helpers` | `iii-browser-sdk/helpers` | `iii.helpers` |
