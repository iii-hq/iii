...
<Callout type="info">
For concrete SDK examples that list functions, workers, triggers, trigger types, or subscribe to function availability changes, see [Discover workers, functions, and triggers](/how-to/discover-workers-functions-triggers).
</Callout>

<CardGroup cols={2}>
  <Card title="Discover workers, functions, and triggers" href="/how-to/discover-workers-functions-triggers" icon="search">
