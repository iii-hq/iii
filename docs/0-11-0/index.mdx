...
The best way to understand iii is to try it. [Install iii](/0-11-0/install) and then follow the [Quickstart](/0-11-0/quickstart) to create your first iii powered project.

## Next Steps

<CardGroup cols={2}>
  <Card title="Install" href="/0-11-0/install" icon="download">
