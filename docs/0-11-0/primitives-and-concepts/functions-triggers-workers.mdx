...
Head over to the [Functions & Triggers](/0-11-0/how-to/use-functions-and-triggers) HOWTO and start building
a iii powered application; or visit the [Quickstart](/0-11-0/quickstart) and try out a working example.

## Still want to learn more?

Check out how [Discovery](/0-11-0/primitives-and-concepts/discovery) works within iii and how it compares to other solutions.
