...
<Info title="Install iii before proceeding">
  Make sure you have installed iii before proceeding. If you haven't then visit the [Install](/0-11-0/install) guide first.
</Info>
...
<Tip>
  See the full [Console documentation](/0-11-0/console) for details on invoking functions, inspecting traces, viewing state, and more.
</Tip>
...
<CardGroup cols={2}>
  <Card title="How to use Functions & Triggers" href="/0-11-0/how-to/use-functions-and-triggers" icon="book-open">
    Learn how to register functions, trigger them, and bind them to events.
  </Card>
  <Card title="Concepts" href="/0-11-0/primitives-and-concepts/functions-triggers-workers" icon="table-layout">
