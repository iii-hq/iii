...
<Info title="How-to guidance">
  For step-by-step instructions, see [Use Topic-Based Queues](/0-11-0/how-to/use-topic-queues) and [Use Named Queues](/0-11-0/how-to/use-named-queues). For DLQ management, see [Manage Failed Triggers](/0-11-0/how-to/dead-letter-queues).
</Info>
...
The producer targets the function and queue explicitly. Queue configuration is centralized. For a hands-on walkthrough, see [Use Named Queues](/0-11-0/how-to/use-named-queues).
...
<Info title="Trigger actions">
  Named queues use the `Enqueue` trigger action. For a full comparison of synchronous, Void, and Enqueue invocation modes, see [Trigger Actions](/0-11-0/how-to/trigger-actions).
</Info>
...
<Info title="Why so many resources?">
  Each named queue creates six RabbitMQ objects to support delayed retry and dead-lettering. For the design rationale, see [Queue Architecture](/0-11-0/architecture/queues).
</Info>
...
<Info title="How-to guide">
  For step-by-step queue setup, see [Use Named Queues](/0-11-0/how-to/use-named-queues) and [Use Topic-Based Queues](/0-11-0/how-to/use-topic-queues).
</Info>
...
<Info title="DLQ operations">
  For a complete guide on inspecting DLQ messages before redriving, see [Manage Failed Triggers](/0-11-0/how-to/dead-letter-queues).
</Info>
