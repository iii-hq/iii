...
See [How to use Functions and Triggers](/0-11-0/how-to/use-functions-and-triggers) for details on registering
...
<Info title="See also">
  For details on building and deploying Workers in production, see the [Quickstart tutorial](/0-11-0/quickstart) or the [SDK Reference](/0-11-0/api-reference/sdk-node).
</Info>
