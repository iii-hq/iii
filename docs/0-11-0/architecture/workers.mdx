...
|--------|----------|------------|
| [HTTP](/0-11-0/workers/iii-http) | HTTP trigger type, request/response handling | `rest_api` |
| [Queue](/0-11-0/workers/iii-queue) | Async message processing with retries | `queue` |
| [Cron](/0-11-0/workers/iii-cron) | Scheduled task execution | `cron` |
| [State](/0-11-0/workers/iii-state) | Key-value state storage with atomic updates | `state` |
| [Stream](/0-11-0/workers/iii-stream) | Real-time data streams with WebSocket push | `stream` |
| [PubSub](/0-11-0/workers/iii-pubsub) | Publish/subscribe messaging | `pubsub` |
| [Observability](/0-11-0/workers/iii-observability) | Structured logging, tracing, and metrics | `observability` |
| [Exec](/0-11-0/workers/iii-exec) | Shell command execution | `exec` |
| [Bridge](/0-11-0/workers/iii-bridge) | WebSocket bridge for SDK connections | `bridge` |
...
<Info title="Custom Workers">
  You can build your own Workers to integrate any service or infrastructure. See [Custom Workers](/0-11-0/advanced/custom-modules) for a detailed guide.
</Info>
