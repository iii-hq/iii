...
<CardGroup cols={2}>
  <Card title="Engine" href="/0-11-0/architecture/engine" icon="server">
    Engine runtime, routing, and configuration.
  </Card>
  <Card title="Workers" href="/0-11-0/architecture/workers" icon="boxes">
    Built-in and external worker model.
  </Card>
  <Card title="Trigger Types" href="/0-11-0/architecture/trigger-types" icon="bolt">
    Trigger registration and call semantics.
  </Card>
  <Card title="Queues" href="/0-11-0/architecture/queues" icon="list-ordered">
