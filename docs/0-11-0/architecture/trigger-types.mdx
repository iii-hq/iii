...
For built-in trigger types (`http`, `cron`, `subscribe`, `state`, `durable:subscriber`, `stream`, `log`), the error message includes the install command for the missing worker.
