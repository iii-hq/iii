...
- **CLI and scripts** — The same schemas document how to build `--payload` for [`iii trigger`](/0-11-0/how-to/trigger-functions-from-cli).
...
<CardGroup cols={2}>
  <Card title="Trigger Functions from the CLI" href="/0-11-0/how-to/trigger-functions-from-cli" icon="terminal">
    Invoke any function with `iii trigger` and a JSON payload
  </Card>
  <Card title="Use Functions & Triggers" href="/0-11-0/how-to/use-functions-and-triggers" icon="code">
