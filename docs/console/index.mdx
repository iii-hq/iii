...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#invoke-a-function) for step-by-step instructions.
</Info>
...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#test-an-http-trigger) for step-by-step instructions on testing each trigger type.
</Info>

<Info title="Trigger types">
  The available trigger types depend on which workers are loaded in your engine configuration. See [Trigger Types](/docs/architecture/trigger-types) and [Workers](/workers) for the full list.
</Info>
...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#manage-state-entries) for step-by-step instructions.
</Info>

<Info title="State persistence">
  State persistence depends on your engine's State worker configuration. With `in_memory` storage, state is lost on engine restart. With `file_based` or `RedisAdapter`, state persists across restarts. See [State Worker](/docs/workers/iii-state) for configuration details.
</Info>
...
<Info title="Stream worker required">
  Streams are provided by the Stream worker. Make sure `iii-stream` is included in your engine configuration. See [Stream Worker](/docs/workers/iii-stream) for details.
</Info>
...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#send-a-test-message-to-a-queue) for step-by-step instructions on testing queues and managing dead letters.
</Info>
...
<Info title="Observability worker required">
  Trace collection requires the Observability worker with `exporter` set to `memory` or `both`. See [Observability Worker](/docs/workers/iii-observability) for configuration.
</Info>
...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#inspect-a-trace) for step-by-step instructions on inspecting traces and spans.
</Info>
...
<Info title="Observability worker required">
  Log collection requires the Observability worker with `logs_enabled: true`. See [Observability Worker](/docs/workers/iii-observability) for configuration.
</Info>
...
<Info title="How-to guide">
  See [Use the Console](/docs/how-to/use-console#navigate-the-flow-graph) for navigation instructions.
</Info>
