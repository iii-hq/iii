...
description: 'A high-level polyglot framework built on the iii SDK providing type safety, declarative configuration, and structured workflows.'
---
...
<CardGroup cols={2}>
  <Card title="Base SDK" href="/tutorials/quickstart" icon="code">
    Learn about the low-level iii SDK
  </Card>
  <Card title="Streams" href="/modules/module-stream" icon="chart-line">
