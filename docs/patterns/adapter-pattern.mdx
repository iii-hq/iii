...
{/* TODO: full worked example wrapping a real third-party API (e.g. Stripe, OpenAI, internal REST
service) as an iii worker. Include the function ID conventions, error mapping from the wrapped
service to iii function errors, and how to handle authentication / secrets. */}
