...
<Note>
  See [Workers](/understanding-iii/workers) for worker lifecycle states and process isolation.
</Note>
...
<Note>
  See [Triggers](/understanding-iii/triggers) for trigger types, the trigger lifecycle, and trigger
  conditions.
</Note>
