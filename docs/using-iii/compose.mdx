...
| Worker declaration  | `MISSING_VERSION_FOR_PACKAGE`, `RUNTIME_ONLY_FOR_BUNDLES`, `PACKAGE_RUN_REQUIRES_HOST_RUNTIME`, `RUNTIME_REQUIRES_BUNDLE`, `NOT_A_PACKAGE_CONTAINER`, `PRE_RUN_TIMEOUT_WITHOUT_PRE_RUN`, `RESERVED_ENV_OVERRIDE`, `MISSING_ENV_FILE`                                                                                                                                                                                         |
