...
{/* TODO: replace this paragraph with the auto-generated engine config reference. Per
project-rules/config.md, the per-field `workers:` schema should not be hand-authored here; this
section is a placeholder pending the generated reference. */}
...
<Note>
  ...
  [Expanding iii / Connecting to the engine](/expanding-iii/workers#connecting-to-the-engine) for more information.
</Note>
