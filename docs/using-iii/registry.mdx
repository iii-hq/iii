...
Browse [workers.iii.dev](https://workers.iii.dev/) to locate a worker that fulfills a capability
your project needs. Each worker page lists the functions and trigger types it provides, its
configuration schema, supported platforms, and agent skills.
...
<Note>
  ...
  verify, etc.), see [CLI / `iii worker`](./cli#worker).
</Note>
