...
export const generateIndex = () => {
  ...
  const hasAuthenticateStream = /export\s+const\s+authenticateStream\b/.test(motiaConfigContent)
  const hasOtelConfig = /export\s+const\s+otel\b/.test(motiaConfigContent)
