...
<Callout type="warn" title="Legacy examples">
  The examples in this section are being migrated to Motia 1.0 and may still include older 0.17-era patterns. Use them as conceptual references only until they are refreshed.
  Start with the [0.17 to 1.0 migration guide](/docs/getting-started/migration-guide) and check the latest source in the [motia-examples repository](https://github.com/MotiaDev/motia-examples).
</Callout>
