        ...
        let json = r#"{
            ...
            "graph": [
                ...
                },
                {
                    ...
                    "package_descriptor": {
                        "identity": {"name": "hello-worker", "version": "1.0.0"},
                        "artifact": {"kind": "rust-binary"}
                    },
                    "descriptor_sha256": "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
                    "artifacts": [{"name": "hello-worker-aarch64", "sha256": "def456"}],
                    "config": {},
                    "binaries": {
                        "aarch64-apple-darwin": {
                            "sha256": "def456",
