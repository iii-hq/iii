...
| Situation | Namespace |
| --- | --- |
| `compose up` with no CLI namespace | inherited from the compose file; autogenerated when the file has none |
...
everything routes through its declared namespace or an autogenerated fallback.
