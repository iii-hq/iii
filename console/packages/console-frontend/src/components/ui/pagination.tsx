    ...
    <div className={`flex items-center justify-between gap-4 ${className}`}>
      ...
      <div className="flex items-center gap-1 md:gap-2">
        ...
        <div className="flex items-center gap-1 px-1 md:px-2">
          <span className="text-[10px] md:text-xs font-medium tabular-nums">{currentPage}</span>
          <span className="text-[10px] md:text-xs text-muted">/</span>
          <span className="text-[10px] md:text-xs text-muted tabular-nums">{totalPages}</span>
        </div>
