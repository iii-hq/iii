...
// Vendored from the omelette animation project (see "Split Race - Styled").
// Local deltas, all marked `iii:` below: React/ReactDOM are imported instead
// of read off window; the global keydown shortcuts and the localStorage
// playhead are removed (a landing page must not eat Space or resume the
// animation mid-run). Keep those deltas when re-syncing upstream.
...
function Stage({
  ...
  // iii: always start at 0 (upstream restored the persisted playhead).
  ...
  // iii: playhead persistence removed.
...
Object.assign(globalThis, { SceneStage, useScene });
