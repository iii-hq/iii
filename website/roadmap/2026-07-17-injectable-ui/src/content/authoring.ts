...
export const CLI_TRACKS: CliTrack[] = [
  {
    ...
    lines: [
      ...
      },
      {
        ...
        fn: "state::ui-content",
        out: [
          "✓ registered console:script state/page.js",
          "→ console fetched content · hash 9f2b6c01 · pushed to every tab",
        ],
      },
      {
  ...
  },
  {
    ...
    lines: [
      ...
      {
        out: [
          "✓ every open tab: dispose → import(?v=<new hash>) → setup(host)",
          "  no console rebuild. no tab refresh.",
        ],
      },
    ],
  },
