    ...
    sections: [
      {
        ...
        items: [
          ...
          {
            name: "sync-on-subscribe",
            desc: "a new subscriber immediately receives the full registry — no seed race.",
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        items: [
          {
            name: "functionCalls",
            desc: "injected renderers first, then the 13 built-in families, then the json fallback.",
          },
