 ...
 * `src/spec-docs.ts` re-exporting its spec's md from `roadmap/generated/`
 * (written by website/scripts/generate-roadmap-manifest.ts before every
 * dev/build), keyed by path. Frontmatter in README.md is stripped by <Markdown>.
 */
