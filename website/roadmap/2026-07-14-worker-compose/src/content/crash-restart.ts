...
export const CRASH_STAGES: TimelineStage[] = [
  {
    ...
    record: {
      ...
      step: "supervise",
      calls: "database · api",
      note: "state.json: pid + birth identity + group",
    },
  },
  {
    id: "crash",
    ...
    record: {
      ...
      step: "children alive",
      calls: "database · api",
      note: "engine connection gone · state on disk",
    },
    gapAfter: true,
  },
  {
    ...
    record: {
      ...
      calls: "pid 48213 ✓ · pid 48214 ?",
      note: "unverifiable → report, never kill",
    },
  },
  {
    id: "reconcile",
    ...
    record: {
      ...
      step: "adopted",
      calls: "database · api",
      note: "zero downtime through the daemon crash",
    },
  },
  {
    id: "cleanup",
    ...
    record: {
      status: "failed",
      step: "cascade dependents",
      calls: "api stopped",
      note: "post_run fired · cause in the logs",
    },
  },
]
