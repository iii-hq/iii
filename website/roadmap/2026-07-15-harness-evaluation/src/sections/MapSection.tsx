...
export function MapSection() {
  ...
  return (
    <Section
      ...
      lede="the integration runner and the agent-quality suite both drive the same harness through harness::send. only the far side of the router boundary differs. click any node to read its datasheet."
    >
