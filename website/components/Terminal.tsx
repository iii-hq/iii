...
export const Terminal: React.FC<TerminalProps> = ({
  ...
  useEffect(() => {
    ...
    const bootSequence = async () => {
      ...
      await new Promise((r) => setTimeout(r, 200));
      addLog("Initializing workers...", "info");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-http listening on 127.0.0.1:3111", "success");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-stream listening on 127.0.0.1:3112", "success");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-state", "success");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-queue (Redis-backed)", "success");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-pubsub", "success");
      await new Promise((r) => setTimeout(r, 150));
      addLog("  ✓ iii-cron (Redis-backed)", "success");
      await new Promise((r) => setTimeout(r, 150));
  ...
  const handleCommand = (cmd: string) => {
    ...
    switch (baseCommand) {
      case "help":
        ...
        addLog("  modules     - List active worker types", "info", "modules");
      ...
      case "status":
        ...
        addLog("", "info");
        addLog("Active workers:", "warning");
        addLog("  ✓ iii-http (port 3111)", "success");
        addLog("  ✓ iii-stream (port 3112)", "success");
        addLog("  ✓ iii-state", "success");
        addLog("  ✓ iii-queue (Redis)", "success");
        addLog("  ✓ iii-pubsub", "success");
        addLog("  ✓ iii-cron (Redis)", "success");
        addLog("  ✓ iii-observability", "success");
        addLog("", "info");
      ...
      case "ports":
        ...
        addLog("  (iii-queue and iii-cron)", "info");
        addLog("", "info");
      ...
      case "redis":
        ...
        addLog("by disabling iii-queue / iii-cron", "info");
        break;
      ...
      case "diagram":
        ...
        addLog("└─────────────────┘", "success");
        addLog("", "info");
        addLog("Flow: Engine → Workers → Adapters → SDK workers", "warning");
        break;

      case "modules":
        addLog("═══ CORE WORKERS ═══", "system");
        addLog("All engine workers built with Rust", "warning");
        addLog("", "info");
      ...
      case "internals":
        ...
        addLog("  Hub (Engine): Manages state, triggers, workers", "info");
      ...
      case "builtins":
        ...
        addLog("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", "error");
        addLog("", "info");
        addLog("HOST FUNCTIONS (registered by workers):", "warning");
        addLog("", "info");
      ...
      case "debug":
        ...
        addLog("", "info");
        addLog("iii-observability:", "warning");
        addLog("  • OpenTelemetry traces, metrics, logs", "info");
