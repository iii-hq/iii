      ...
      {isActive && (
        <div className="flex justify-end px-3 py-2 border-t border-iii-medium/10">
          {!writeDone && !isWriting && (
            <button
              onClick={handleWrite}
              className="px-4 py-1.5 text-xs font-bold rounded bg-iii-accent text-iii-black hover:brightness-110 transition-all duration-200 cursor-pointer animate-[socketPulse_2s_ease-in-out_infinite]"
            >
