    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {isActive && step.action && !clicked && (
          <button
            onClick={handleClick}
            className="mt-3 px-4 py-1.5 text-xs font-bold rounded bg-iii-accent text-iii-black hover:brightness-110 transition-all duration-200 animate-[socketPulse_2s_ease-in-out_infinite] cursor-pointer"
          >
            {step.action.label}
          </button>
        )}
