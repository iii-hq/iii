...
purpose; worker-backed capability skills live with their worker docs.
...
- [iii-getting-started](iii-getting-started/SKILL.md) — Install iii, create a project, write your first worker
- [iii-core-primitives](iii-core-primitives/SKILL.md) — Functions, triggers, invocation modes, trigger schemas, custom triggers, channels, and HTTP-invoked functions
